...
Trifle.WhileTargetTileIsInLineOfSightIn5TriggerBrain = function(triggerContext) {
...
Trifle.WhileTargetTileIsInLineOfSightIn5TriggerBrain.prototype.isTriggerMet = function() {
	this.targetTiles = [];

	var sightTilePoints = this.board.getPointsForTilesInLineOfSightIn5(this.thisTilePoint);
